...
export const ThemeToggleButton = ({ theme, onClick }: ThemeToggleButtonProps) => (
    <button onClick={onClick} className="theme-toggle-button" aria-label={`Switch to ${theme === 'light' ? 'dark' : 'light'} mode`} title={`Switch to ${theme === 'light' ? 'dark' : 'light'} mode`}>
        {theme === 'light' ? (
